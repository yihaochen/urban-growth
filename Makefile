...
test: build
	...
	docker exec -it lambda python3 -c 'from handler import calc_urban_score, read_json; print(calc_urban_score({"query_id": 0, "product_id": "LC08_L1TP_047027_20190828_20190903_01_T1", "geojson_s3_key": "geojson/seattle-city-limits.geojson"}, None))'
	docker exec -it lambda python3 -c 'from handler import calc_urban_score, read_json; print(calc_urban_score({"query_id": 0, "product_id": "LC08_L1TP_047027_20190828_20190903_01_T1", "geojson": read_json("seattle-city-limits.geojson")}, None))'
